...
export const Intro = () => {
  ...
  return (
    <div className="grid grid-cols-2 p-5 overflow-x-hidden">
      <div className="my-auto">
        <h2 className="intro-heading text-4xl font-bold font-style">Hello :)</h2>
        <p className="para-1 my-6 text-lg leading-5 tracking-wide text-gray-600 font-body" ref={ref}>
        ...
        <p className="para-2 my-3 text-lg leading-5 tracking-wide text-gray-600 font-body">
