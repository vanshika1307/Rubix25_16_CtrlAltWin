...
export const Intro = () => {
  ...
  return (
    <div className="grid grid-cols-2 p-5 overflow-x-hidden font-serif">
      <div className="my-auto">
        <h2 className="intro-heading text-4xl font-bold">Hello :)</h2>
        <p className="para-1 my-3 text-lg leading-5 tracking-wide text-gray-600" ref={ref}>
        ...
        <p className="para-2 my-3 text-lg leading-5 tracking-wide text-gray-600">
